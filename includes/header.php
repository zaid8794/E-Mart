                ...
                <div class="side-menu-area">
                    ...
                    <nav>
                        <ul class="sidebar-menu" data-widget="tree">
                            ...
                            <li><a href="product.php"><i class='fa fa-th'></i><span>Products</span></a></li>
                            <li class="treeview">
                            ...
                            <li><a href="widgets.html"><i class="zmdi zmdi-widgets"></i><span>Widgets</span></a></li>
                            <li class="menu-header-title">Custom</li>
                            <li class="treeview">
                                <a href="javascript:void(0)"><i class="bx bx-file"></i><span>Pages</span> <i class="fa fa-angle-right"></i></a>
                                <ul class="treeview-menu">
                                    <li><a href="timeline.html">Timeline</a></li>
                                    <li><a href="slider.html">Slider</a></li>
                                    <li><a href="sweet.html">Sweet Alert</a></li>
                                    ...
                                    <li><a href="clint-list.html">Client List</a></li>
                                    <li><a href="contact.html">Contact</a></li>
                                    <li><a href="gallery.html">Gallery</a></li>
                                    <li><a href="light-box.html">Gallery 2</a></li>
                                    <li><a href="ribbons.html">Ribbons</a></li>
                                    <li><a href="team.html">Members</a></li>
                                    <li><a href="task.html">Task Zone</a></li>
                                    <li><a href="404.html">404</a></li>
                                </ul>
                            </li>
                            <li class="treeview">
                                <a href="javascript:void(0)"><i class="bx bx-user-circle"></i><span>Authentication</span> <i class="fa fa-angle-right"></i></a>
                                <ul class="treeview-menu">
                            ...
                            <li class="menu-header-title">Components</li>
                            <li class="treeview">
                                <a href="javascript:void(0)"><i class="bx bx-tone"></i> <span>UI Elements</span> <i class="fa fa-angle-right"></i></a>
                                <ul class="treeview-menu">
                            ...
                            <li class="treeview">
                                <a href="javascript:void(0)"><i class='bx bx-bar-chart-square'></i><span>Charts</span>
                                    <i class="fa fa-angle-right"></i></a>
                                <ul class="treeview-menu">
                                    <li><a href="apex-chart.html">Apex Chart</a></li>
                                    <li><a href="chartist.html">Chartist Js</a></li>
                                    <li><a href="chart-js.html">Chart Js</a></li>
                                    <li><a href="morris-chart.html">Morris Js</a></li>
                                    <li><a href="c3-charts.html">C3 Js</a></li>
                                </ul>
                            </li>

                            <li class="treeview">
                                <a href="javascript:void(0)"><i class="bx bxs-eraser"></i><span>Forms</span> <i class="fa fa-angle-right"></i></a>
                                <ul class="treeview-menu">
                            ...
                            <li class="treeview">
                                <a href="javascript:void(0)"><i class='bx bx-table'></i><span>Tables</span> <i class="fa fa-angle-right"></i></a>
                                <ul class="treeview-menu">
                            ...
                            <li class="treeview">
                                <a href="javascript:void(0)"><i class="bx bx-list-ul"></i><span>Icons</span> <i class="fa fa-angle-right"></i></a>
                                <ul class="treeview-menu">
                            ...
                            <li class="treeview">
                                <a href="javascript:void(0)"><i class="bx bx-share-alt"></i> <span>Dropdown</span> <i class="fa fa-angle-right"></i></a>
                                <ul class="treeview-menu">
